...
{
    public class AssessmentSessionDocument
    {
        [JsonProperty("id")]
        ...
        public List<QuestionAnswerDocument> CollectedQuestionsAndAnswers { get; set; } = new();
        ...
        public AssessmentDocument? FinalAssessment { get; set; }
